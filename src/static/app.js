            ...
            <ul class="participants-list">
              ${details.participants.length > 0
                ? details.participants
                    .map(
                      (email) =>
                        `<li><span class="participant-name">${email}</span><button type="button" class="participant-remove" data-activity="${name}" data-email="${email}" title="Unregister participant">×</button></li>`
                    )
                    .join("")
